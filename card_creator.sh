...
if [ $QUIET == 'false' ] ; then echo Creating directory $OUTFOLDER; fi
mkdir -p $OUTFOLDER

for SUIT in ${CARDSUITS[@]}
do
    if [ $QUIET == 'false' ] ; then echo --------------------------------------; fi
    if [ $QUIET == 'false' ] ; then echo Working on $SUIT; fi
    if [ $QUIET == 'false' ] ; then echo --------------------------------------; fi
    case $SUIT in
    ...
    do
        ...
        echo "</svg>" >> "$OUTFILE"
        if [ $QUIET == 'false' ] ; then echo Done with $FACEVAL of $SUIT.; fi
    done
    if [ $QUIET == 'false' ] ; then echo --------------------------------------; fi
    if [ $QUIET == 'false' ] ; then echo Done with $SUIT; fi
done
if [ $QUIET == 'false' ] ; then echo --------------------------------------; fi
if [ $QUIET == 'false' ] ; then echo All finished. Enjoy; fi